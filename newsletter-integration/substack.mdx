...
Your domain information and content access are handled with the highest security standards:

- **Encrypted Storage**: All connection data is encrypted using industry-standard AES-256 encryption
- **Limited Usage**: Your domain is only accessed when performing specific actions like importing content or syncing data
- **No Unnecessary Access**: We never access your Substack data for any purpose other than the features you've explicitly enabled
- **Complete Deletion**: When you disconnect the integration, all associated data is immediately and permanently deleted from our servers
- **Secure Transmission**: All communications use HTTPS with TLS 1.3 encryption
